...
<nav>
  ...
  <div class="layar-penuh">
    <div class="tampilan">
      ...
      <div class="posisi">
        <div class="card">
        <a href="Pesan_Bus.php" class="btn-order">
            <div class="btn-block">
              Pesan Bus
            </div>
          </a>
          <a href="Pesan_Hotel.php" class="btn-order">
            <div class="btn-block">
              Pesan Hotel
            </div>
          </a>
          <a href="Riwayat_Hotel.php" class="btn-order">
            <div class="btn-block">
              Riwayat Pesan Hotel
            </div>
          </a>
          <a href="Riwayat_Bus.php" class="btn-order">
            <div class="btn-block">
              Riwayat Pesan Bus
            </div>
          </a>
